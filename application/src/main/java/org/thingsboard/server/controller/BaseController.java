...
public abstract class BaseController {
    ...
    Testing checkTestingId(TestingId testingId, Operation operation) throws ThingsboardException {
        try {
            validateId(testingId, "Incorrect deviceId " + testingId);
            Testing testing = testingService.findTestingById(getCurrentUser().getTenantId(), testingId);
            checkNotNull(testing);
            accessControlService.checkPermission(getCurrentUser(), Resource.DEVICE, operation, testingId, testing);
            return testing;
        } catch (Exception e) {
            throw handleException(e, false);
        }
