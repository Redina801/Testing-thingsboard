...
@Component({
  selector: 'tb-testing-credentials-dialog',
  templateUrl: './testing-credentials-dialog.component.html',
  providers: [{provide: ErrorStateMatcher, useExisting: TestingCredentialsDialogComponent}],
  styleUrls: []
})
export class TestingCredentialsDialogComponent extends
  DialogComponent<TestingCredentialsDialogComponent, DeviceCredentials> implements OnInit, ErrorStateMatcher {
  ...
  constructor(protected store: Store<AppState>,
              ...
              public dialogRef: MatDialogRef<TestingCredentialsDialogComponent, DeviceCredentials>,
